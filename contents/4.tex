...
\end{itemize}
\includegraphics[width=0.3\linewidth]{contents/4.2.2.1.png}
\includegraphics[width=0.3\linewidth]{contents/4.2.2.2.png}
\includegraphics[width=0.3\linewidth]{contents/4.2.2.4.png}
\subsection*{4.2.3 Combination}
\begin{itemize}
    \item Straddle - Long Call, Long Put $X$
    \item Strip - Long Call, Long 2x Put $X$
    \item Strap - Long 2x Call, Long Put $X$
    \item Strangle - Long Call $X_2$, Long Put $X_1$
\end{itemize}
\includegraphics[width=0.3\linewidth]{contents/4.2.3.4.png}
