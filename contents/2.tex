...
\includegraphics[width=0.8\linewidth]{contents/2.2.4.png}
...
\[X = (\frac{d_{0,T}}{d_{0,T+m}}-1)\times\frac{360}{m}\]
Value of FRA
\[v=[d_{t,T} - (1+X\times\frac{m}{360})\times d_{t,T+m}]\times N\]
