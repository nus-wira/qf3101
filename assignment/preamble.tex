...
\newcommand{\handout}[5]{
	...
	\begin{center}
		\framebox{
			\vbox{
				\hbox to 5.78in { {\bf #1} \hfill }
				\hbox to 5.78in { {\hfill #2} }
				\vspace{4mm}
...
\newcommand{\header}[3]{\handout{NUS QF3101: Investment Instrument and Risk Management}{\today}{Instructor: Tan Hwee Huat}{Student: #2\quad#3}{#1}}
...
% Replace defaault \arabic numbering with \alph
